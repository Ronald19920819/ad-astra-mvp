...
function createSnapshot() {
  return createActivitySubmissionSnapshot({
    ...
    activity: {
      id: "activity-1",
      version: 1,
      title: "Activity 2 â€“ Market Research",
...
test("a submission snapshot preserves the exact submitted title and total", () => {
  ...
  assert.equal(snapshot.activity.title, "Activity 2 â€“ Market Research");
...
test("different learners can retain independent activity versions", () => {
  ...
  const versionTwo = createActivitySubmissionSnapshot({
    ...
    activity: {
      ...versionOne.activity,
      version: 2,
      title: "Activity 2 â€“ Updated Market Research",
      totalMarks: 25,
    },
    questions: [
  ...
  assert.equal(versionOne.activity.title, "Activity 2 â€“ Market Research");
