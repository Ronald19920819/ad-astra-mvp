...
export default function MotivationalCard() {
  ...
  return (
    <div
      className="motivation-card isolate relative mb-5 overflow-hidden rounded-[2rem] border border-blue-100 bg-white shadow-sm lg:min-h-[168px]"
    ...
    >
      <div
        className="relative z-10 flex items-center lg:justify-between"
        style={{
          minHeight: "105px",
      ...
      >
        ...
        <div className="flex flex-1 items-start gap-3 px-4 lg:justify-center lg:px-8">
          <div
      ...
      <div className="relative z-10 mb-4 flex justify-center gap-2 lg:mt-1">
        {quotes.map((_, index) => (
          <button
            type="button"
            key={index}
