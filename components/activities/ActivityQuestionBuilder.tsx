...
export type ActivityQuestion = {
  ...
  // Confidential marking key (formula/method/expected result/mark
  // allocation) generated by Kingdom Author for Calculation questions.
  // Persisted to activity_questions.answer_text, never rendered to the
  // learner. Undefined for every other question type.
  ...
  >
    ...
    {subjectKey === "business-studies" && (question.paper === "paper-1" ? (
      <>
        ...
        <option value="calculation">Calculation – 4 marks</option>
