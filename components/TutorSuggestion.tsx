...
export default function TutorSuggestion() {
  return (
    <div className="rounded-[1.8rem] bg-[#DED6C8] p-5 shadow-lg mb-5 overflow-hidden relative">
      <div className="relative z-10 max-w-[65%]">
        <p
  className="mt-2 text-m font-bold text-[#0f172a] leading-relaxed"
  style={{ opacity: 0.9 }}
>
  Meet Kingdom, your tutor
        ...
        <p
  className="mt-2 text-sm font-bold text-[#0f172a] leading-relaxed"
  style={{ opacity: 0.8 }}
>
