...
exports.businessStudiesSubject = exports.subjectConfigurations = void 0;
exports.getSubjectConfiguration = getSubjectConfiguration;
exports.isSubjectKey = isSubjectKey;
exports.getSubjectConfigurationByDatabaseId = getSubjectConfigurationByDatabaseId;
exports.getSubjectConfigurationsForFamily = getSubjectConfigurationsForFamily;
exports.getCanonicalSubjectConfiguration = getCanonicalSubjectConfiguration;
exports.buildSubjectRoute = buildSubjectRoute;
exports.buildSubjectDetailRoute = buildSubjectDetailRoute;
exports.resolveSubjectConfigurationForFamily = resolveSubjectConfigurationForFamily;
...
function getSubjectConfiguration(subjectKey) {
    return exports.subjectConfigurations[subjectKey];
}
function isSubjectKey(value) {
    return value in exports.subjectConfigurations;
}
function getSubjectConfigurationByDatabaseId(subjectId) {
    return Object.values(exports.subjectConfigurations).find((subject) => subject.databaseId === subjectId);
}
function getSubjectConfigurationsForFamily(familyKey) {
    return Object.values(exports.subjectConfigurations).filter((subject) => subject.familyKey === familyKey);
}
function getCanonicalSubjectConfiguration(familyKey) {
    return Object.values(exports.subjectConfigurations).find((subject) => subject.familyKey === familyKey && subject.key === familyKey);
}
function buildSubjectRoute(subject, routeKey) {
    return `${subject.routes[routeKey]}?subject=${encodeURIComponent(subject.databaseId)}`;
}
function buildSubjectDetailRoute(subject, routeKey, detailId) {
    return `${subject.routes[routeKey]}/${detailId}?subject=${encodeURIComponent(subject.databaseId)}`;
}
function resolveSubjectConfigurationForFamily(familyKey, selectedSubjectId) {
    if (selectedSubjectId) {
        const selectedSubject = getSubjectConfigurationByDatabaseId(selectedSubjectId);
...
exports.businessStudiesSubject = exports.subjectConfigurations["business-studies"];
