  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-[#EEF7FF] to-[#FFF8E6] p-6 pb-48">
      <div className="max-w-md mx-auto">
        <div className="bg-white/90 backdrop-blur rounded-3xl shadow-sm border border-blue-100 p-4 flex items-center gap-4 mb-8">
          <Image
          ...
          <div>
            <p className={`${oxanium.className} text-xl text-black tracking-wide`}>
              AD ASTRA
            </p>
        ...
        <div className="bg-white rounded-3xl shadow-sm border border-blue-100 p-5 mb-6">
...
<div className="space-y-4">
  {learner.subjects.map((subject) => (
    <div
      key={subject.slug}
      className="bg-white rounded-3xl shadow-sm border border-blue-100 p-5"
    >
      {subject.slug === "business-studies" ? (
        <Link href="/business-studies-dashboard">
          <div className="cursor-pointer">
            <h2
              className={`${indieFlower.className} text-3xl text-black mb-3`}
            >
              {subject.name}
            </h2>
