      ...
      <div className="max-w-md mx-auto">
        ...
        <section className="mb-5 rounded-[2rem] border border-blue-100 bg-white p-5 shadow-sm">
          ...
          <div className="space-y-3">
            <Link href="/business-studies-activity">
              <div className="rounded-2xl border border-blue-100 bg-[#F8FBFF] p-4 shadow-sm">
        ...
        <section className="rounded-[2rem] border border-blue-100 bg-white p-5 shadow-sm">
          <div className="mb-4 flex items-center justify-between">
            ...
            <ChevronDown size={22} className="text-[#2563EB]" />
          </div>
          ...
          <div className="space-y-3">
            <details className="rounded-2xl border border-blue-100 bg-white p-4">
              ...
              <div className="mt-4 space-y-2">
                <Link href="/business-studies-activity">
                  <div className="rounded-2xl bg-[#F8FBFF] p-4 shadow-sm border border-blue-100">
