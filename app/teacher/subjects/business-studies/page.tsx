      ...
      <div className="max-w-md mx-auto">
        ...
        <section className="mb-5 rounded-[2rem] border border-orange-100 bg-white p-5 shadow-sm">
          ...
          <p className="mb-4 text-sm leading-relaxed text-black/70">
            Upload lesson videos and readings that learners will access in their
            Business Studies Classroom.
          </p>

          <div className="grid grid-cols-2 gap-3">
            <button className="flex flex-col items-center justify-center gap-2 rounded-2xl bg-[#FFF3E6] p-4 text-sm font-semibold text-[#F97316]">
              <Video size={20} />
              Upload Video
            </button>
        ...
        <section className="mb-5 rounded-[2rem] border border-orange-100 bg-white p-5 shadow-sm">
          ...
          <p className="mb-4 text-sm leading-relaxed text-black/70">
            Create and manage activities linked to lessons, readings and learner
            submissions.
          </p>

          <button className="mb-3 flex w-full items-center justify-center gap-2 rounded-2xl bg-[#F97316] py-3 text-sm font-semibold text-white">
            <Upload size={18} />
            Upload Activity
          </button>
