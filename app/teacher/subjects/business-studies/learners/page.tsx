import { businessStudiesLearners } from "@/app/data/BSMock";
...
export default function BusinessStudiesLearnersPage() {
 const learners = businessStudiesLearners;
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-3 text-sm">
                ...
                <div className="rounded-2xl bg-slate-50 p-3">
                  ...
                  <p className="text-lg font-bold text-orange-500">
                    {learner.reviewsNeeded}
                  </p>
                </div>
              </div>

              <button className="mt-4 flex w-full items-center justify-center gap-2 rounded-2xl bg-orange-500 py-3 text-sm font-semibold text-white">
                <Eye size={17} />
