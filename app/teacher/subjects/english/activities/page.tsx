...
export default function EnglishActivitiesPage() {
  ...
  const [activities, setActivities] = useState([
    {
      title: "Activity 6 - Recognising an Author's Style",
      lesson: "Lesson 2.6",
      marks: "20",
      due: "Friday",
      status: "Published",
    ...
    {
      title: "Activity 7 - Creating Original Characters",
      lesson: "Lesson 2.7",
      marks: "20",
      due: "Friday",
      status: "Published",
        ...
        <div className="mb-5 rounded-[2rem] border border-blue-100 bg-white p-5 shadow-sm">
          ...
          <div className="mt-4 grid grid-cols-3 gap-3">
            <div className="rounded-2xl bg-blue-50 p-4 text-center">
              <FileUp className="mx-auto mb-2 text-blue-500" size={20} />
              <p className="text-xs font-medium">Upload File</p>
            </div>

            <div className="rounded-2xl bg-blue-50 p-4 text-center">
              <ClipboardList className="mx-auto mb-2 text-blue-500" size={20} />
              <p className="text-xs font-medium">Worksheet</p>
            </div>

            <div className="rounded-2xl bg-blue-50 p-4 text-center">
              <CalendarDays className="mx-auto mb-2 text-blue-500" size={20} />
          ...
          <button
            ...
            className="mt-4 flex w-full items-center justify-center gap-2 rounded-2xl bg-blue-500 py-3 font-semibold text-white"
          >
            <Rocket size={18} />
            Publish Activity
          </button>
        ...
        <div className="rounded-[2rem] border border-blue-100 bg-white p-5 shadow-sm">
          ...
          <div className="space-y-3">
            {activities.map((activity, index) => (
              <div
                key={index}
                className="rounded-2xl border border-blue-100 p-4"
              >
