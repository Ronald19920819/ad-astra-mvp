...
export default function EnglishActivityReviewPage() {
  const activities = [
    {
      activity: "Activity 7",
                  ...
                  <tbody>
                    {activity.learners.map((learner, index) => (
                      ...
                      >
                        ...
                        <td className="p-3 text-center">
                          <Link
                            href="/teacher/subjects/english/review/submission"
                            className="mx-auto flex w-fit items-center justify-center gap-1 rounded-full bg-blue-500 px-3 py-2 text-[10px] font-semibold text-white"
                          >
                            <FileSearch size={13} />
                            Open
                          </Link>
