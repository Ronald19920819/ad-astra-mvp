...
export default function EnglishLearnersPage() {
  const learners = [
    {
        ...
        <div className="space-y-4">
          {learners.map((learner, index) => (
            ...
            >
              <div className="mb-4 flex items-center justify-between gap-3">
                <div className="flex items-center gap-3">
                  <div className="rounded-2xl bg-blue-50 p-3">
                    <UserRound className="text-blue-500" size={22} />
                  </div>
              ...
              <button className="mt-4 flex w-full items-center justify-center gap-2 rounded-2xl bg-blue-500 py-3 text-sm font-semibold text-white">
                <Eye size={17} />
