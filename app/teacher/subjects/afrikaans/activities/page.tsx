...
export default function AfrikaansActivitiesPage() {
  ...
  const [activities, setActivities] = useState([
    {
      title: "Aktiwiteit 6 - Begripstoets",
      lesson: "Les 2.6",
      marks: "20",
      due: "Friday",
      status: "Published",
    ...
    {
      title: "Aktiwiteit 7 - Taalstrukture",
      lesson: "Les 2.7",
      marks: "20",
      due: "Friday",
      status: "Published",
        ...
        <div className="mb-5 rounded-[2rem] border border-red-100 bg-white p-5 shadow-sm">
          <div className="mb-4 flex items-center gap-3">
            <div className="rounded-2xl bg-red-50 p-3">
              <Plus className="text-red-500" size={22} />
            </div>
          ...
          <div className="mt-4 grid grid-cols-3 gap-3">
            <div className="rounded-2xl bg-red-50 p-4 text-center">
              <FileUp className="mx-auto mb-2 text-red-500" size={20} />
              <p className="text-xs font-medium">Upload File</p>
            </div>

            <div className="rounded-2xl bg-red-50 p-4 text-center">
              <ClipboardList className="mx-auto mb-2 text-red-500" size={20} />
              <p className="text-xs font-medium">Worksheet</p>
            </div>

            <div className="rounded-2xl bg-red-50 p-4 text-center">
              <CalendarDays className="mx-auto mb-2 text-red-500" size={20} />
          ...
          <button
            ...
            className="mt-4 flex w-full items-center justify-center gap-2 rounded-2xl bg-red-500 py-3 font-semibold text-white"
          >
            <Rocket size={18} />
            Publish Activity
          </button>
