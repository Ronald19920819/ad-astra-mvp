...
export default function HistoryActivityReviewPage() {
  const activities = [
    {
      activity: "Activity 7",
      title: "Who Was More to Blame for the Cold War?",
      total: 30,
      open: true,
      learners: [
        {
                  ...
                  <tbody>
                    {activity.learners.map((learner, index) => (
                      ...
                      >
                        ...
                        <td className="p-3 text-center">
                          <Link
                            href="/teacher/subjects/history/review/submission"
                            className="mx-auto flex w-fit items-center justify-center gap-1 rounded-full bg-green-500 px-3 py-2 text-[10px] font-semibold text-white"
                          >
                            <FileSearch size={13} />
                            Open
                          </Link>
